				...
				<div className="flex flex-col md:flex-row gap-12">
					...
					<div>
						...
						<div className="flex gap-4 text-xl text-[#48505E]">
							...
							<a href="https://www.linkedin.com/company/owa-by-pepcode/">
								<svg
									width="24"
									height="24"
									viewBox="0 0 24 24"
								...
								>
									<path
										d="M20 2H4C2.9 2 2 2.9 2 4V20C2 21.1 2.9 22 4 22H20C21.1 22 22 21.1 22 20V4C22 2.9 21.1 2 20 2ZM8 19H5V10H8V19ZM6.5 8.5C5.5 8.5 4.7 7.7 4.7 6.7C4.7 5.7 5.5 4.9 6.5 4.9C7.5 4.9 8.3 5.7 8.3 6.7C8.3 7.7 7.5 8.5 6.5 8.5ZM19 19H16V14C16 12.8 15.2 12 14 12C12.8 12 12 12.8 12 14V19H9V10H12V11.5C12.6 10.6 13.6 10 14.8 10C16.8 10 19 11.5 19 14.5V19Z"
										fill="#48505E"
									/>
								</svg>
							</a>
